@extends('errors.minimal', ['title' => 'غير مصرح بالوصول | توريد'])

@section('content')
    <x-error-page code="403" heading="غير مصرح لك بالوصول"
        description="ليس لديك الصلاحية الكافية لعرض هذه الصفحة. إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع فريق توريد.">
