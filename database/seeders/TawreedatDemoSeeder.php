    ...
    private function seedNews(): void
    {
        $items = [
            [
                ...
                'content' => 'شهدت أسعار بعض مواد البناء الأساسية تغيرات طفيفة هذا الأسبوع، حيث سجلت مواد التشييد الأساسية استقراراً نسبياً مقارنة بالأسابيع الماضية. ننصح المقاولين والموردين بمتابعة السوق بشكل دوري عبر منصة توريدات.',
                'days_ago' => 1,
            ],
            [
            ...
            [
                'title' => 'انضمام شركات جديدة إلى منصة توريدات في قطاع الحديد',
                'category' => 'منصة',
                'excerpt' => 'توسع قائمة الموردين المعتمدين في قطاع الحديد والمعادن على المنصة.',
                'content' => 'رحّبت منصة توريدات بانضمام عدد من الموردين الجدد المتخصصين في الحديد والمعادن، في إطار جهودها المستمرة لتوسيع دليل الشركات وتسهيل الوصول إلى موردين موثوقين.',
                'days_ago' => 7,
            ],
            [
